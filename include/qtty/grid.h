// qtty/grid.h — L3 grid metrics, style, and the alignment guard (§5.3).
#pragma once
#include <QProxyStyle>
#include <QRect>
#include <QSize>
...
// InputRouter-owned focus (§5.5, measured F4): under the offscreen platform no
...
// §5.3/§5.4: cell-multiple metrics for layouts and widgets; Channel A

...
qtty/
  ...
  src/widgets/            replaced widgets (editor, calendar)
  src/backends/
    termpaint/            reference backend
    legacy-app1/ …4/      adapters over existing implementations
    null/                 CI backend
  tests/snapshots/        text fixtures
  tools/qtty-inspect, qtty-replay
  examples/chat/          canonical example: dual-frontend chat with stickers
...
The chat spike was promoted to `examples/chat/` — the example that ships with the
